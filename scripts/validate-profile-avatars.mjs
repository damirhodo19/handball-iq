...
const storagePolicyFix = read('supabase/migrations/20260812191500_fix_avatar_storage_admin_check.sql');
...
check(storagePolicyFix.includes('public.current_user_is_admin()') && !storagePolicyFix.includes('OR public.is_admin()'), 'avatar read policy uses the client-safe admin check');
